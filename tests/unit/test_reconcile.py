...
def test_build_query_src():
    ...
    actual = QueryBuilder(table_conf=table_conf, schema=schema, layer="source", source="oracle").build_hash_query()
    print(actual)
...
def test_build_query_tgt():
    ...
    actual = QueryBuilder(table_conf=table_conf, schema=schema, layer="target", source="databricks").build_hash_query()
    print(actual)
