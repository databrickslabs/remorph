...
path_expected_exceptions = Path(__file__).parent / Path('../../resources/functional/snowflake_expected_exceptions/')
functional_tests_expected_exceptions = get_functional_test_files_from_directory(
    path_expected_exceptions, "snowflake", "databricks", True
)
