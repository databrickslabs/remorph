...
class TestDialectUtils:
    def test_snow_query_with_no_unsupported_lca_usage(self):
        dialect = "SNOWFLAKE"
        sql = """
            SELECT
                t.col1,
    ...
    def test_snow_query_with_lca_in_where(self):
        dialect = "SNOWFLAKE"
        sql = """
            SELECT
                t.col1,
    ...
    def test_snow_query_with_lca_in_window(self):
        dialect = "SNOWFLAKE"
        sql = """
            SELECT
                t.col1,
    ...
    def test_snow_query_with_error(self):
        dialect = "SNOWFLAKE"
        sql = """
            SELECT
                t.col1
