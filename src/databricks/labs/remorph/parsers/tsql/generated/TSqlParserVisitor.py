...
class TSqlParserVisitor(ParseTreeVisitor):
    ...
    def visitAlter_assembly_drop_multiple_files(self,
                                                ctx: TSqlParser.Alter_assembly_drop_multiple_filesContext):
        return self.visitChildren(ctx)
    ...
    def visitAlter_assembly_client_file_clause(self,
                                               ctx: TSqlParser.Alter_assembly_client_file_clauseContext):
        return self.visitChildren(ctx)
    ...
    def visitAsymmetric_key_password_change_option(
            self, ctx: TSqlParser.Asymmetric_key_password_change_optionContext):
        return self.visitChildren(ctx)
    ...
    def visitAlter_authorization_for_sql_database(
            self, ctx: TSqlParser.Alter_authorization_for_sql_databaseContext):
        return self.visitChildren(ctx)
    ...
    def visitAlter_authorization_for_parallel_dw(self,
                                                 ctx: TSqlParser.Alter_authorization_for_parallel_dwContext):
        return self.visitChildren(ctx)
    ...
    def visitDrop_database_audit_specification(self,
                                               ctx: TSqlParser.Drop_database_audit_specificationContext):
        return self.visitChildren(ctx)
    ...
    def visitDrop_statistics_name_azure_dw_and_pdw(
            self, ctx: TSqlParser.Drop_statistics_name_azure_dw_and_pdwContext):
        return self.visitChildren(ctx)
    ...
    def visitEndpoint_encryption_alogorithm_clause(
            self, ctx: TSqlParser.Endpoint_encryption_alogorithm_clauseContext):
        return self.visitChildren(ctx)
    ...
    def visitEvent_session_predicate_expression(self,
                                                ctx: TSqlParser.Event_session_predicate_expressionContext):
        return self.visitChildren(ctx)
    ...
    def visitAlter_database_audit_specification(self,
                                                ctx: TSqlParser.Alter_database_audit_specificationContext):
        return self.visitChildren(ctx)
    ...
    def visitCreate_database_audit_specification(self,
                                                 ctx: TSqlParser.Create_database_audit_specificationContext):
        return self.visitChildren(ctx)
    ...
    def visitCreate_schema_azure_sql_dw_and_pdw(self,
                                                ctx: TSqlParser.Create_schema_azure_sql_dw_and_pdwContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by TSqlParser#alter_schema_azure_sql_dw_and_pdw.
    def visitAlter_schema_azure_sql_dw_and_pdw(self,
                                               ctx: TSqlParser.Alter_schema_azure_sql_dw_and_pdwContext):
        return self.visitChildren(ctx)
    ...
    def visitCreate_server_audit_specification(self,
                                               ctx: TSqlParser.Create_server_audit_specificationContext):
        return self.visitChildren(ctx)
    ...
    def visitSingle_partition_rebuild_index_options(
            self, ctx: TSqlParser.Single_partition_rebuild_index_optionsContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by TSqlParser#single_partition_rebuild_index_option.
    def visitSingle_partition_rebuild_index_option(
            self, ctx: TSqlParser.Single_partition_rebuild_index_optionContext):
        return self.visitChildren(ctx)
    ...
    def visitCreate_nonclustered_columnstore_index(
            self, ctx: TSqlParser.Create_nonclustered_columnstore_indexContext):
        return self.visitChildren(ctx)
    ...
    def visitDate_correlation_optimization_option(
            self, ctx: TSqlParser.Date_correlation_optimization_optionContext):
        return self.visitChildren(ctx)
    ...
    def visitDrop_relational_or_xml_or_spatial_index(
            self, ctx: TSqlParser.Drop_relational_or_xml_or_spatial_indexContext):
        return self.visitChildren(ctx)
    ...
    def visitDeclare_set_cursor_common_partial(self,
                                               ctx: TSqlParser.Declare_set_cursor_common_partialContext):
        return self.visitChildren(ctx)
    ...
    def visitGET_FILESTREAM_TRANSACTION_CONTEXT(self,
                                                ctx: TSqlParser.GET_FILESTREAM_TRANSACTION_CONTEXTContext):
        return self.visitChildren(ctx)
    ...
    def visitFunc_proc_name_server_database_schema(
            self, ctx: TSqlParser.Func_proc_name_server_database_schemaContext):
        return self.visitChildren(ctx)
