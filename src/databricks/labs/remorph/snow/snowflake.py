...
def _parse_seq(args: list):
    # TODO: Implement the logic for the sequence better
    logger.warning(
        "The seq[1/2/4/8] function in Snowflake and monotonically_increasing_id in Databricks are equivalent in logic, "
        "but the output size generated by seq[1/2/4/8] can be different. Please be cautious while using."
    )
    args = []
