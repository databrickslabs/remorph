...
class Table:
    ...
    def get_select_columns(self, schema: list[Schema], layer: str) -> set[str] | str:
    ...
    def get_transformation_dict(self, layer: str) -> dict[str, str] | None:
        if self.transformations:
            ...
            return {self.get_layer_src_to_tgt_col_mapping(t.column_name, layer): t.target for t in self.transformations}
        return None
