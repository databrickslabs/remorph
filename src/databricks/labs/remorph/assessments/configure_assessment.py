...
class ConfigureAssessment:
    ...
    def run(self):
        ...
        logger.info("Please follow the instructions to configure your access token" + _DOC_URL)
        webbrowser.open(_DOC_URL)
        logger.info("Please run the following command to configure your Databricks CLI profile")
        logger.info("databricks configure --profile remorph_assessment --host " + workspace_url)
