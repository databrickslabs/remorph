...
class WorkspaceInstaller:
    ...
    def configure(self) -> MorphConfig:
        ...
        skip_validation_str = self._prompts.choice_from_dict("Do you want to Skip Validation",
                                                             {"Yes": "true", "No": "false"})
...
class WorkspaceInstallation:
    ...
    def run(self):
        logger.info(f"Installing Remorph v{PRODUCT_INFO.version()}")
        self._create_debug()
        logger.info(f"Installation completed successfully! Please refer to the  for the next steps.")
