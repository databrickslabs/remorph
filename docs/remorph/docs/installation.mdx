...
<div className='bg-gray-100 p-4 rounded-lg'>
    <img src={useBaseUrl('img/remorph-logo-no-background.png')} alt="Databricks Labs Remorph" />
</div>
-----
...
```
The Flag `--configure-cluster` gives you the prompt to select the cluster_id from the available cluster ids on your workspace.
Alternatively you can use the environment variable `DATABRICKS_CLUSTER_ID` t set the cluster id you would want to use
