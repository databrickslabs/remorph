...
# Authoring Docs to Remorph

import Admonition from '@theme/Admonition';

# Authoring Documentation

This document provides guidelines for writing documentation for the Remorph project.


## Tech Stack

The Remorph documentation is built using [Docusaurus](https://docusaurus.io/), a modern static site generator.
...
The markdown files are located in the `docs` directory of the Remorph project.
...
1. Clone the Remorph repository
2. Run:
...
<div className='bg-gray-100 p-4 rounded-lg'>
  <img src={useBaseUrl('/img/remorph-logo.png')} alt="remorph" />
</div>
```
