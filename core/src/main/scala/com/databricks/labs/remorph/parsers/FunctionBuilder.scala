...
object FunctionBuilder {
  ...
  def functionArity(functionName: String): Option[FunctionArity] = functionName match {
    ...
    case "@@CURSOR_STATUS" => Some(FixedArity(0, convertible = false))
    case "@@FETCH_STATUS" => Some(FixedArity(0, convertible = false))
    ...
    case "ARRAYAGG" => Some(FixedArity(1))
    ...
    case "BINARY_CHECKSUM" => Some(VariableArity(1, Int.MaxValue))
    ...
    case "CHECKSUM" => Some(VariableArity(1, Int.MaxValue))
    ...
    case "CURSOR_ROWS" => Some(FixedArity(0))
    case "CURSOR_STATUS" => Some(FixedArity(2, convertible = false))
    ...
    case "IDENTITY" => Some(VariableArity(1, 3))
    ...
    case "LISTAGG" => Some(VariableArity(1, 2))
    ...
    case "SESSION_USER" => Some(FixedArity(0))
    ...
    case "SYSTEM_USER" => Some(FixedArity(0))
