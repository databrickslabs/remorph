...
class TSqlAstBuilder(override val vc: TSqlVisitorCoordinator)
  ...
  override def visitTSqlFile(ctx: TSqlParser.TSqlFileContext): ir.WithKnownOrigin[ir.LogicalPlan] =
  ...
  override def visitExecuteBodyBatch(ctx: TSqlParser.ExecuteBodyBatchContext): ir.WithKnownOrigin[ir.LogicalPlan] =
    withOriginFromContext(ctx) {
  ...
  override def visitSqlClauses(ctx: TSqlParser.SqlClausesContext): ir.WithKnownOrigin[ir.LogicalPlan] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDmlClause(ctx: TSqlParser.DmlClauseContext): ir.WithKnownOrigin[ir.LogicalPlan] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
