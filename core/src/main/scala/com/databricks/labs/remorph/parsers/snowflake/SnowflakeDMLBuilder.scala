...
class SnowflakeDMLBuilder(override val vc: SnowflakeVisitorCoordinator)
    extends SnowflakeParserBaseVisitor[ir.WithKnownLocationRange[ir.Modification]]
  ...
  override def visitDmlCommand(ctx: DmlCommandContext): ir.WithKnownLocationRange[ir.Modification] = {
  ...
  override def visitInsertStatement(ctx: InsertStatementContext): ir.WithKnownLocationRange[ir.Modification] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDeleteStatement(ctx: DeleteStatementContext): ir.WithKnownLocationRange[ir.Modification] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitUpdateStatement(ctx: UpdateStatementContext): ir.WithKnownLocationRange[ir.Modification] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ...
          val sources =
            Option(ctx.tableSources()).map(t =>
              vc.relationBuilder.visitMany(t.tableSource()).foldLeft[ir.LogicalPlan](target)(crossJoin))
          val where = Option(ctx.searchCondition()).map(_.accept(vc.expressionBuilder))
  ...
  override def visitMergeStatement(ctx: MergeStatementContext): ir.WithKnownLocationRange[ir.Modification] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
