...
class SnowflakeDMLBuilder(override val vc: SnowflakeVisitorCoordinator)
    extends SnowflakeParserBaseVisitor[ir.WithKnownOrigin[ir.Modification]]
  ...
  override def visitDmlCommand(ctx: DmlCommandContext): ir.WithKnownOrigin[ir.Modification] =
  ...
  override def visitInsertStatement(ctx: InsertStatementContext): ir.WithKnownOrigin[ir.Modification] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDeleteStatement(ctx: DeleteStatementContext): ir.WithKnownOrigin[ir.Modification] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitUpdateStatement(ctx: UpdateStatementContext): ir.WithKnownOrigin[ir.Modification] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitMergeStatement(ctx: MergeStatementContext): ir.WithKnownOrigin[ir.Modification] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
