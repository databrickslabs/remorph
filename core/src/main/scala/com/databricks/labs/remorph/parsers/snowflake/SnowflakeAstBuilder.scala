...
class SnowflakeAstBuilder(override val vc: SnowflakeVisitorCoordinator)
  ...
  override def visitSnowflakeFile(ctx: SnowflakeFileContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
  ...
  override def visitSqlClauses(ctx: SqlClausesContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitQueryStatement(ctx: QueryStatementContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDdlCommand(ctx: DdlCommandContext): ir.WithKnownLocationRange[ir.LogicalPlan] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildCTE(
      ctx: WithExpressionContext,
      relation: ir.LogicalPlan): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    if (ctx == null) {
      return relation.asInstanceOf[ir.WithKnownLocationRange[ir.LogicalPlan]]
    }
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
  ...
  private def buildSetOperator(
      left: ir.LogicalPlan,
      ctx: SetOperatorsContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDmlCommand(ctx: DmlCommandContext): ir.WithKnownLocationRange[ir.LogicalPlan] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitOtherCommand(ctx: OtherCommandContext): ir.WithKnownLocationRange[ir.LogicalPlan] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitSnowSqlCommand(ctx: SnowSqlCommandContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      ir.UnresolvedCommand(
        ruleText = contextText(ctx),
        ruleName = vc.ruleName(ctx),
