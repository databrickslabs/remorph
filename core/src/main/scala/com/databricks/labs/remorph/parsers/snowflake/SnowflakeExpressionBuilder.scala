...
class SnowflakeExpressionBuilder(override val vc: SnowflakeVisitorCoordinator)
    extends SnowflakeParserBaseVisitor[ir.WithKnownLocationRange[ir.Expression]]
  ...
  protected override def unresolved(ruleText: String, message: String): ir.WithKnownLocationRange[ir.Expression] =
  ...
  override def visitFunctionCall(ctx: FunctionCallContext): ir.WithKnownLocationRange[ir.Expression] = {
  ...
  override def visitValuesTable(ctx: ValuesTableContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitGroupByElem(ctx: GroupByElemContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitId(ctx: IdContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private[snowflake] def buildId(ctx: IdContext): ir.Id = {
    withLocationRangeFromRuleContext(ctx) {
      ctx match {
  ...
  override def visitSelectListElem(ctx: SelectListElemContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExpressionElem(ctx: ExpressionElemContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitColumnElem(ctx: ColumnElemContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDotIdentifier(ctx: DotIdentifierContext): ir.WithKnownLocationRange[ir.ObjectReference] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitColumnPosition(ctx: ColumnPositionContext): ir.WithKnownLocationRange[ir.Position] = {
    withLocationRangeFromRuleContext(ctx) {
      ir.Position(ctx.INT().getText.toInt)
    }
  }

  override def visitColumnElemStar(ctx: ColumnElemStarContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildAlias(ctx: AsAliasContext, input: ir.Expression): ir.WithKnownLocationRange[ir.Expression] = {
    if (ctx == null) {
      input.asInstanceOf[ir.WithKnownLocationRange[ir.Expression]]
    } else {
      withLocationRangeFromRuleContext(ctx) {
        val alias = buildId(ctx.alias().id())
        ir.Alias(input, alias)
      }
    }
  }

  override def visitColumnName(ctx: ColumnNameContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitOrderItem(ctx: OrderItemContext): ir.WithKnownLocationRange[ir.SortOrder] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitLiteral(ctx: LiteralContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
   ...
   */
  override def visitString(ctx: SnowflakeParser.StringContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitTrueFalse(ctx: TrueFalseContext): ir.WithKnownLocationRange[ir.Literal] =
    withLocationRangeFromRuleContext(ctx) {
      ctx.TRUE() match {
  ...
  override def visitExprNot(ctx: ExprNotContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ctx.NOT().asScala.foldLeft(ctx.expr().accept(this)) { case (e, _) =>
            ir.Not(e).withLocationRange(e.locationRange)
          }
      }
    }
  }

  override def visitExprAnd(ctx: ExprAndContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprOr(ctx: ExprOrContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitNonLogicalExpression(ctx: NonLogicalExpressionContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprPrecedence(ctx: ExprPrecedenceContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprNextval(ctx: ExprNextvalContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprDot(ctx: ExprDotContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprColon(ctx: ExprColonContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprCollate(ctx: ExprCollateContext): ir.WithKnownLocationRange[ir.Expression] =
    withLocationRangeFromRuleContext(ctx) {
      withLocationRangeFromRuleContext(ctx) {
        errorCheck(ctx) match {
          case Some(errorResult) => errorResult
  ...
  override def visitExprCase(ctx: ExprCaseContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprIff(ctx: ExprIffContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprComparison(ctx: ExprComparisonContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprDistinct(ctx: ExprDistinctContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprWithinGroup(ctx: ExprWithinGroupContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprOver(ctx: ExprOverContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprCast(ctx: ExprCastContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprAscribe(ctx: ExprAscribeContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprSign(ctx: ExprSignContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprPrecedence0(ctx: ExprPrecedence0Context): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprPrecedence1(ctx: ExprPrecedence1Context): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprPrimitive(ctx: ExprPrimitiveContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprFuncCall(ctx: ExprFuncCallContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitJsonLiteral(ctx: JsonLiteralContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitArrayLiteral(ctx: ArrayLiteralContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPrimArrayAccess(ctx: PrimArrayAccessContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPrimExprColumn(ctx: PrimExprColumnContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPrimObjectAccess(ctx: PrimObjectAccessContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPrimExprLiteral(ctx: PrimExprLiteralContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitIffExpr(ctx: IffExprContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitCastExpr(ctx: CastExprContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitRankingWindowedFunction(
      ctx: RankingWindowedFunctionContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildFrameBound(ctx: WindowFrameBoundContext): ir.FrameBoundary = {
    ctx match {
  ...
  override def visitStandardFunction(ctx: StandardFunctionContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitAggFuncExprList(ctx: AggFuncExprListContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitAggFuncStar(ctx: AggFuncStarContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitAggFuncList(ctx: AggFuncListContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitBuiltinExtract(ctx: BuiltinExtractContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildIdFromString(ctx: SnowflakeParser.StringContext): ir.Id = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitCaseExpression(ctx: CaseExpressionContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScNot(ctx: ScNotContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScAnd(ctx: ScAndContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScOr(ctx: ScOrContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScPred(ctx: ScPredContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScPrec(ctx: ScPrecContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredExists(ctx: PredExistsContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredBinop(ctx: PredBinopContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredASA(ctx: PredASAContext): ir.WithKnownLocationRange[ir.Expression] =
    // TODO: build ASA
    withLocationRangeFromRuleContext(ctx) {
      ir.UnresolvedExpression(
  ...
  override def visitPredBetween(ctx: PredBetweenContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredIn(ctx: PredInContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredLikeSinglePattern(
      ctx: PredLikeSinglePatternContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredLikeMultiplePatterns(
      ctx: PredLikeMultiplePatternsContext): ir.WithKnownLocationRange[ir.Expression] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredRLike(ctx: PredRLikeContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredIsNull(ctx: PredIsNullContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredExpr(ctx: PredExprContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitParamAssoc(ctx: ParamAssocContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitSetColumnValue(ctx: SetColumnValueContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprSubquery(ctx: ExprSubqueryContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
