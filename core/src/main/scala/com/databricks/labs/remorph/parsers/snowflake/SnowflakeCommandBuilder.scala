...
class SnowflakeCommandBuilder(override val vc: SnowflakeVisitorCoordinator)
    extends SnowflakeParserBaseVisitor[ir.WithKnownOrigin[ir.Command]]
  ...
  override def visitDeclareWithDefault(ctx: DeclareWithDefaultContext): ir.WithKnownOrigin[ir.Command] =
  ...
  override def visitDeclareSimple(ctx: DeclareSimpleContext): ir.WithKnownOrigin[ir.Command] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDeclareResultSet(ctx: DeclareResultSetContext): ir.WithKnownOrigin[ir.Command] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitLetVariableAssignment(ctx: LetVariableAssignmentContext): ir.WithKnownOrigin[ir.Command] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExecuteTask(ctx: ExecuteTaskContext): ir.WithKnownOrigin[ir.Command] = withOriginFromContext(ctx) {
  ...
  override def visitOtherCommand(ctx: OtherCommandContext): ir.WithKnownOrigin[ir.Command] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
