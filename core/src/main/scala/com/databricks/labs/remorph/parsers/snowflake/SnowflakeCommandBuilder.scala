...
class SnowflakeCommandBuilder(override val vc: SnowflakeVisitorCoordinator)
    extends SnowflakeParserBaseVisitor[ir.WithKnownLocationRange[ir.Command]]
    with ParserCommon[ir.Command]
    with LocationTracking {

  // The default result is returned when there is no visitor implemented, and we produce an unresolved
  // object to represent the input that we have no visitor for.
  protected override def unresolved(ruleText: String, message: String): ir.WithKnownLocationRange[ir.Command] =
  ...
  override def visitDeclareWithDefault(ctx: DeclareWithDefaultContext): ir.WithKnownLocationRange[ir.Command] =
  ...
  override def visitDeclareSimple(ctx: DeclareSimpleContext): ir.WithKnownLocationRange[ir.Command] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDeclareResultSet(ctx: DeclareResultSetContext): ir.WithKnownLocationRange[ir.Command] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitLetVariableAssignment(ctx: LetVariableAssignmentContext): ir.WithKnownLocationRange[ir.Command] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExecuteTask(ctx: ExecuteTaskContext): ir.WithKnownLocationRange[ir.Command] =
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitOtherCommand(ctx: OtherCommandContext): ir.WithKnownLocationRange[ir.Command] =
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
