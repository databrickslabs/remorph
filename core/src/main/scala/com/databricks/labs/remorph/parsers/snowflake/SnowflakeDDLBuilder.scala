...
class SnowflakeDDLBuilder(override val vc: SnowflakeVisitorCoordinator)
    extends SnowflakeParserBaseVisitor[ir.WithKnownLocationRange[ir.Catalog]]
    with ParserCommon[ir.Catalog]
    with LocationTracking {

  // The default result is returned when there is no visitor implemented, and we produce an unresolved
  // object to represent the input that we have no visitor for.
  protected override def unresolved(ruleText: String, message: String): ir.WithKnownLocationRange[ir.Catalog] =
  ...
  override def visitDdlCommand(ctx: DdlCommandContext): ir.WithKnownLocationRange[ir.Catalog] = {
  ...
  override def visitCreateCommand(ctx: CreateCommandContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ctx match {
            ...
            case _ =>
              ir.UnresolvedCatalog(
                ...
                "Unknown CREATE XXX command",
                ruleName = "createCommand")
          }
      }
    }
  }

  override def visitCreateFunction(ctx: CreateFunctionContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitCreateTable(ctx: CreateTableContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitCreateTableAsSelect(ctx: CreateTableAsSelectContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitCreateStream(ctx: CreateStreamContext): ir.WithKnownLocationRange[ir.Catalog] =
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitCreateTask(ctx: CreateTaskContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      ir.UnresolvedCommand(
        ruleText = contextText(ctx),
  ...
  override def visitCreateUser(ctx: CreateUserContext): ir.WithKnownLocationRange[ir.Catalog] =
    withLocationRangeFromRuleContext(ctx) {
      ir.UnresolvedCommand(
        ruleText = contextText(ctx),
  ...
  override def visitAlterCommand(ctx: AlterCommandContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitAlterTable(ctx: AlterTableContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
