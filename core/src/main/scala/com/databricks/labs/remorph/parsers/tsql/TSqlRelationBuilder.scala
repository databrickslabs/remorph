...
class TSqlRelationBuilder(override val vc: TSqlVisitorCoordinator)
    extends TSqlParserBaseVisitor[ir.WithKnownLocationRange[ir.LogicalPlan]]
  ...
  override def visitCommonTableExpression(
      ctx: CommonTableExpressionContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
  ...
  override def visitSelectStatementStandalone(
      ctx: TSqlParser.SelectStatementStandaloneContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitSelectStatement(
      ctx: TSqlParser.SelectStatementContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitQueryExpression(
      ctx: TSqlParser.QueryExpressionContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ctx match {
            case qs if qs.querySpecification() != null =>
              qs.querySpecification().accept(this) // TODO: Implement set ops
            case _ =>
  ...
  override def visitQuerySpecification(
      ctx: TSqlParser.QuerySpecificationContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildOrderBy(
      ctx: SelectOrderByClauseContext,
      input: ir.LogicalPlan): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    if (ctx == null) {
      input.asInstanceOf[ir.WithKnownLocationRange[ir.LogicalPlan]]
    } else {
      ...
      errorCheck(ctx) match {
        ...
        case None =>
          ...
          tableSources match {
            ...
            case sources =>
              sources
                .asInstanceOf[Seq[ir.LogicalPlan]]
                .reduce(
                  ir.Join(
                    _,
                    _,
  ...
  override def visitTableName(ctx: TableNameContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitTableSourceItem(ctx: TableSourceItemContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitTsiNamedTable(ctx: TsiNamedTableContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitTsiDerivedTable(ctx: TsiDerivedTableContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDerivedTable(ctx: DerivedTableContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitTableValueConstructor(
      ctx: TableValueConstructorContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitMerge(ctx: MergeContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ...
          val sourcePlan = tableSourcesPlan.tail.foldLeft(tableSourcesPlan.head.asInstanceOf[ir.LogicalPlan])(
          ...
          val (matchedActions, notMatchedActions, notMatchedBySourceActions) = Option(ctx.whenMatch())
            .map(
              _.asScala.foldLeft((List.empty[ir.MergeAction], List.empty[ir.MergeAction], List.empty[ir.MergeAction])) {
  ...
  override def visitUpdate(ctx: UpdateContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ...
          val sourceRelation = tableSourcesOption.map { tableSources =>
            tableSources.tail.foldLeft(tableSources.head.asInstanceOf[ir.LogicalPlan])(ir
              .Join(_, _, None, ir.CrossJoin, Seq(), ir.JoinDataType(is_left_struct = false, is_right_struct = false)))
          }
  ...
  override def visitDelete(ctx: DeleteContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitInsert(ctx: InsertContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitInsertStatementValue(
      ctx: InsertStatementValueContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitOutputClause(ctx: OutputClauseContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDdlObject(ctx: DdlObjectContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildJoinPart(left: ir.LogicalPlan, ctx: JoinPartContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      ctx match {
  ...
  private def buildUnpivot(left: ir.LogicalPlan, ctx: UnpivotContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  private def buildPivot(left: ir.LogicalPlan, ctx: PivotContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  private def buildApply(left: ir.LogicalPlan, ctx: ApplyContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  private def buildCrossJoin(left: ir.LogicalPlan, ctx: CrossJoinContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      val rightRelation = ctx.tableSourceItem().accept(this)
      ir.Join(
        left,
