...
case class UnexpectedTableAlteration(offendingTableAlteration: String) extends RemorphError {
...
case class UnsupportedGroupType(offendingGroupType: String) extends RemorphError {
...
case class UnsupportedDataType(offendingDataType: String) extends RemorphError {
