...
/**
 * Extractor object used to match instances of `CallFunction` in a case insensitive manner. The following pattern `case
 * CaseInsensitiveCallFunction("FOO", args) => ...` will match `CallFunction("foo", Seq(...))` as well as
 * `CallFunction("FOO", Seq(...))`, etc.
 *
 * The function name specified in the pattern must be all uppercase for this to work.
 */
object CaseInsensitiveCallFunction {
  def unapply(call: CallFunction): Option[(String, Seq[Expression])] = {
    Some((call.function_name.toUpperCase(), call.arguments))
  }
}
...
class CallMapper {
  ...
  def convert(call: Fn): Fn = call match {
    case CaseInsensitiveCallFunction("ABS", args) => Abs(args.head)
    case CaseInsensitiveCallFunction("ACOS", args) => Acos(args.head)
    case CaseInsensitiveCallFunction("ACOSH", args) => Acosh(args.head)
    case CaseInsensitiveCallFunction("ADD_MONTHS", args) => AddMonths(args.head, args(1))
    case CaseInsensitiveCallFunction("AGGREGATE", args) => ArrayAggregate(args.head, args(1), args(2), args(3))
    case CaseInsensitiveCallFunction("ANY", args) => BoolOr(args.head)
    case CaseInsensitiveCallFunction("APPROX_COUNT_DISTINCT", args) => HyperLogLogPlusPlus(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAYS_OVERLAP", args) => ArraysOverlap(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAYS_ZIP", args) => ArraysZip(args)
    case CaseInsensitiveCallFunction("ARRAY_CONTAINS", args) => ArrayContains(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAY_DISTINCT", args) => ArrayDistinct(args.head)
    case CaseInsensitiveCallFunction("ARRAY_EXCEPT", args) => ArrayExcept(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAY_INTERSECT", args) => ArrayIntersect(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAY_JOIN", args) => ArrayJoin(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("ARRAY_MAX", args) => ArrayMax(args.head)
    case CaseInsensitiveCallFunction("ARRAY_MIN", args) => ArrayMin(args.head)
    case CaseInsensitiveCallFunction("ARRAY_POSITION", args) => ArrayPosition(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAY_REMOVE", args) => ArrayRemove(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAY_REPEAT", args) => ArrayRepeat(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAY_SORT", args) => ArraySort(args.head, args(1))
    case CaseInsensitiveCallFunction("ARRAY_UNION", args) => ArrayUnion(args.head, args(1))
    case CaseInsensitiveCallFunction("ASCII", args) => Ascii(args.head)
    case CaseInsensitiveCallFunction("ASIN", args) => Asin(args.head)
    case CaseInsensitiveCallFunction("ASINH", args) => Asinh(args.head)
    case CaseInsensitiveCallFunction("ASSERT_TRUE", args) => AssertTrue(args.head, args(1))
    case CaseInsensitiveCallFunction("ATAN", args) => Atan(args.head)
    case CaseInsensitiveCallFunction("ATAN2", args) => Atan2(args.head, args(1))
    case CaseInsensitiveCallFunction("ATANH", args) => Atanh(args.head)
    case CaseInsensitiveCallFunction("AVG", args) => Average(args.head)
    case CaseInsensitiveCallFunction("BASE64", args) => Base64(args.head)
    case CaseInsensitiveCallFunction("BIN", args) => Bin(args.head)
    case CaseInsensitiveCallFunction("BIT_AND", args) => BitAndAgg(args.head)
    case CaseInsensitiveCallFunction("BIT_COUNT", args) => BitwiseCount(args.head)
    case CaseInsensitiveCallFunction("BIT_LENGTH", args) => BitLength(args.head)
    case CaseInsensitiveCallFunction("BIT_OR", args) => BitOrAgg(args.head)
    case CaseInsensitiveCallFunction("BIT_XOR", args) => BitXorAgg(args.head)
    case CaseInsensitiveCallFunction("BOOL_AND", args) => BoolAnd(args.head)
    case CaseInsensitiveCallFunction("BROUND", args) => BRound(args.head, args(1))
    case CaseInsensitiveCallFunction("CBRT", args) => Cbrt(args.head)
    case CaseInsensitiveCallFunction("CEIL", args) => Ceil(args.head)
    case CaseInsensitiveCallFunction("CHAR", args) => Chr(args.head)
    case CaseInsensitiveCallFunction("COALESCE", args) => Coalesce(args)
    case CaseInsensitiveCallFunction("COLLECT_LIST", args) => CollectList(args.head)
    case CaseInsensitiveCallFunction("COLLECT_SET", args) => CollectSet(args.head)
    case CaseInsensitiveCallFunction("CONCAT", args) => Concat(args)
    case CaseInsensitiveCallFunction("CONCAT_WS", args) => ConcatWs(args)
    case CaseInsensitiveCallFunction("CONV", args) => Conv(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("CORR", args) => Corr(args.head, args(1))
    case CaseInsensitiveCallFunction("COS", args) => Cos(args.head)
    case CaseInsensitiveCallFunction("COSH", args) => Cosh(args.head)
    case CaseInsensitiveCallFunction("COT", args) => Cot(args.head)
    case CaseInsensitiveCallFunction("COUNT", args) => Count(args)
    case CaseInsensitiveCallFunction("COUNT_IF", args) => CountIf(args.head)
    case CaseInsensitiveCallFunction("COUNT_MIN_SKETCH", args) =>
      CountMinSketchAgg(args.head, args(1), args(2), args(3))
    case CaseInsensitiveCallFunction("COVAR_POP", args) => CovPopulation(args.head, args(1))
    case CaseInsensitiveCallFunction("COVAR_SAMP", args) => CovSample(args.head, args(1))
    case CaseInsensitiveCallFunction("CRC32", args) => Crc32(args.head)
    case CaseInsensitiveCallFunction("CUBE", args) => Cube(args)
    case CaseInsensitiveCallFunction("CUME_DIST", _) => CumeDist()
    case CaseInsensitiveCallFunction("CURRENT_CATALOG", _) => CurrentCatalog()
    case CaseInsensitiveCallFunction("CURRENT_DATABASE", _) => CurrentDatabase()
    case CaseInsensitiveCallFunction("CURRENT_DATE", _) => CurrentDate()
    case CaseInsensitiveCallFunction("CURRENT_TIMESTAMP", _) => CurrentTimestamp()
    case CaseInsensitiveCallFunction("CURRENT_TIMEZONE", _) => CurrentTimeZone()
    case CaseInsensitiveCallFunction("DATEDIFF", args) => DateDiff(args.head, args(1))
    case CaseInsensitiveCallFunction("DATE_ADD", args) => DateAdd(args.head, args(1))
    case CaseInsensitiveCallFunction("DATE_FORMAT", args) => DateFormatClass(args.head, args(1))
    case CaseInsensitiveCallFunction("DATE_FROM_UNIX_DATE", args) => DateFromUnixDate(args.head)
    case CaseInsensitiveCallFunction("DATE_PART", args) => DatePart(args.head, args(1))
    case CaseInsensitiveCallFunction("DATE_SUB", args) => DateSub(args.head, args(1))
    case CaseInsensitiveCallFunction("DATE_TRUNC", args) => TruncTimestamp(args.head, args(1))
    case CaseInsensitiveCallFunction("DAYOFMONTH", args) => DayOfMonth(args.head)
    case CaseInsensitiveCallFunction("DAYOFWEEK", args) => DayOfWeek(args.head)
    case CaseInsensitiveCallFunction("DAYOFYEAR", args) => DayOfYear(args.head)
    case CaseInsensitiveCallFunction("DECODE", args) => Decode(args.head, args(1))
    case CaseInsensitiveCallFunction("DEGREES", args) => ToDegrees(args.head)
    case CaseInsensitiveCallFunction("DENSE_RANK", args) => DenseRank(args)
    case CaseInsensitiveCallFunction("DIV", args) => IntegralDivide(args.head, args(1))
    case CaseInsensitiveCallFunction("E", _) => EulerNumber()
    case CaseInsensitiveCallFunction("ELEMENT_AT", args) => ElementAt(args.head, args(1))
    case CaseInsensitiveCallFunction("ELT", args) => Elt(args)
    case CaseInsensitiveCallFunction("ENCODE", args) => Encode(args.head, args(1))
    case CaseInsensitiveCallFunction("EXISTS", args) => ArrayExists(args.head, args(1))
    case CaseInsensitiveCallFunction("EXP", args) => Exp(args.head)
    case CaseInsensitiveCallFunction("EXPLODE", args) => Explode(args.head)
    case CaseInsensitiveCallFunction("EXPM1", args) => Expm1(args.head)
    case CaseInsensitiveCallFunction("EXTRACT", args) => Extract(args.head, args(1))
    case CaseInsensitiveCallFunction("FACTORIAL", args) => Factorial(args.head)
    case CaseInsensitiveCallFunction("FILTER", args) => ArrayFilter(args.head, args(1))
    case CaseInsensitiveCallFunction("FIND_IN_SET", args) => FindInSet(args.head, args(1))
    case CaseInsensitiveCallFunction("FIRST", args) => First(args.head, args(1))
    case CaseInsensitiveCallFunction("FLATTEN", args) => Flatten(args.head)
    case CaseInsensitiveCallFunction("FLOOR", args) => Floor(args.head)
    case CaseInsensitiveCallFunction("FORALL", args) => ArrayForAll(args.head, args(1))
    case CaseInsensitiveCallFunction("FORMAT_NUMBER", args) => FormatNumber(args.head, args(1))
    case CaseInsensitiveCallFunction("FORMAT_STRING", args) => FormatString(args)
    case CaseInsensitiveCallFunction("FROM_CSV", args) => CsvToStructs(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("FROM_JSON", args) => JsonToStructs(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("FROM_UNIXTIME", args) => FromUnixTime(args.head, args(1))
    case CaseInsensitiveCallFunction("FROM_UTC_TIMESTAMP", args) => FromUTCTimestamp(args.head, args(1))
    case CaseInsensitiveCallFunction("GET_JSON_OBJECT", args) => GetJsonObject(args.head, args(1))
    case CaseInsensitiveCallFunction("GREATEST", args) => Greatest(args)
    case CaseInsensitiveCallFunction("GROUPING", args) => Grouping(args.head)
    case CaseInsensitiveCallFunction("GROUPING_ID", args) => GroupingID(args)
    case CaseInsensitiveCallFunction("HASH", args) => Murmur3Hash(args)
    case CaseInsensitiveCallFunction("HEX", args) => Hex(args.head)
    case CaseInsensitiveCallFunction("HOUR", args) => Hour(args.head)
    case CaseInsensitiveCallFunction("HYPOT", args) => Hypot(args.head, args(1))
    case CaseInsensitiveCallFunction("IF", args) => If(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("IFNULL", args) => IfNull(args.head, args(1))
    case CaseInsensitiveCallFunction("IN", args) => In(args.head, args.tail) // TODO: not a function
    case CaseInsensitiveCallFunction("INITCAP", args) => InitCap(args.head)
    case CaseInsensitiveCallFunction("INLINE", args) => Inline(args.head)
    case CaseInsensitiveCallFunction("INPUT_FILE_BLOCK_LENGTH", _) => InputFileBlockLength()
    case CaseInsensitiveCallFunction("INPUT_FILE_BLOCK_START", _) => InputFileBlockStart()
    case CaseInsensitiveCallFunction("INPUT_FILE_NAME", _) => InputFileName()
    case CaseInsensitiveCallFunction("INSTR", args) => StringInstr(args.head, args(1))
    case CaseInsensitiveCallFunction("ISNAN", args) => IsNaN(args.head)
    case CaseInsensitiveCallFunction("ISNOTNULL", args) => IsNotNull(args.head)
    case CaseInsensitiveCallFunction("ISNULL", args) => IsNull(args.head)
    case CaseInsensitiveCallFunction("JAVA_METHOD", args) => CallMethodViaReflection(args)
    case CaseInsensitiveCallFunction("JSON_ARRAY_LENGTH", args) => LengthOfJsonArray(args.head)
    case CaseInsensitiveCallFunction("JSON_OBJECT_KEYS", args) => JsonObjectKeys(args.head)
    case CaseInsensitiveCallFunction("JSON_TUPLE", args) => JsonTuple(args)
    case CaseInsensitiveCallFunction("KURTOSIS", args) => Kurtosis(args.head)
    case CaseInsensitiveCallFunction("LAG", args) => Lag(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("LAST", args) => Last(args.head, args(1))
    case CaseInsensitiveCallFunction("LAST_DAY", args) => LastDay(args.head)
    case CaseInsensitiveCallFunction("LEAD", args) => Lead(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("LEAST", args) => Least(args)
    case CaseInsensitiveCallFunction("LEFT", args) => Left(args.head, args(1))
    case CaseInsensitiveCallFunction("LENGTH", args) => Length(args.head)
    case CaseInsensitiveCallFunction("LEVENSHTEIN", args) => Levenshtein(args.head, args(1))
    case CaseInsensitiveCallFunction("LN", args) => Log(args.head)
    case CaseInsensitiveCallFunction("LOG", args) => Logarithm(args.head, args(1))
    case CaseInsensitiveCallFunction("LOG10", args) => Log10(args.head)
    case CaseInsensitiveCallFunction("LOG1P", args) => Log1p(args.head)
    case CaseInsensitiveCallFunction("LOG2", args) => Log2(args.head)
    case CaseInsensitiveCallFunction("LOWER", args) => Lower(args.head)
    case CaseInsensitiveCallFunction("LPAD", args) =>
      StringLPad(args.head, args(1), args.lastOption.getOrElse(Literal(" ")))
    case CaseInsensitiveCallFunction("LTRIM", args) => StringTrimLeft(args.head, args(1))
    case CaseInsensitiveCallFunction("MAKE_DATE", args) => MakeDate(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("MAKE_INTERVAL", args) =>
      MakeInterval(args.head, args(1), args(2), args(3), args(4), args(5))
    case CaseInsensitiveCallFunction("MAKE_TIMESTAMP", args) =>
      MakeTimestamp(args.head, args(1), args(2), args(3), args(4), args(5), args(6))
    case CaseInsensitiveCallFunction("MAP", args) => CreateMap(args, useStringTypeWhenEmpty = false)
    case CaseInsensitiveCallFunction("MAP_CONCAT", args) => MapConcat(args)
    case CaseInsensitiveCallFunction("MAP_ENTRIES", args) => MapEntries(args.head)
    case CaseInsensitiveCallFunction("MAP_FILTER", args) => MapFilter(args.head, args(1))
    case CaseInsensitiveCallFunction("MAP_FROM_ARRAYS", args) => MapFromArrays(args.head, args(1))
    case CaseInsensitiveCallFunction("MAP_FROM_ENTRIES", args) => MapFromEntries(args.head)
    case CaseInsensitiveCallFunction("MAP_KEYS", args) => MapKeys(args.head)
    case CaseInsensitiveCallFunction("MAP_VALUES", args) => MapValues(args.head)
    case CaseInsensitiveCallFunction("MAP_ZIP_WITH", args) => MapZipWith(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("MAX", args) => Max(args.head)
    case CaseInsensitiveCallFunction("MAX_BY", args) => MaxBy(args.head, args(1))
    case CaseInsensitiveCallFunction("MD5", args) => Md5(args.head)
    case CaseInsensitiveCallFunction("MIN", args) => Min(args.head)
    case CaseInsensitiveCallFunction("MINUTE", args) => Minute(args.head)
    case CaseInsensitiveCallFunction("MIN_BY", args) => MinBy(args.head, args(1))
    case CaseInsensitiveCallFunction("MOD", args) => Remainder(args.head, args(1))
    case CaseInsensitiveCallFunction("MONOTONICALLY_INCREASING_ID", _) => MonotonicallyIncreasingID()
    case CaseInsensitiveCallFunction("MONTH", args) => Month(args.head)
    case CaseInsensitiveCallFunction("MONTHS_BETWEEN", args) => MonthsBetween(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("NAMED_STRUCT", args) => CreateNamedStruct(args)
    case CaseInsensitiveCallFunction("NANVL", args) => NaNvl(args.head, args(1))
    case CaseInsensitiveCallFunction("NEGATIVE", args) => UnaryMinus(args.head)
    case CaseInsensitiveCallFunction("NEXT_DAY", args) => NextDay(args.head, args(1))
    case CaseInsensitiveCallFunction("NOW", _) => Now()
    case CaseInsensitiveCallFunction("NTH_VALUE", args) => NthValue(args.head, args(1))
    case CaseInsensitiveCallFunction("NTILE", args) => NTile(args.head)
    case CaseInsensitiveCallFunction("NULLIF", args) => NullIf(args.head, args(1))
    case CaseInsensitiveCallFunction("NVL", args) => Nvl(args.head, args(1))
    case CaseInsensitiveCallFunction("NVL2", args) => Nvl2(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("OCTET_LENGTH", args) => OctetLength(args.head)
    case CaseInsensitiveCallFunction("OVERLAY", args) => Overlay(args.head, args(1), args(2), args(3))
    case CaseInsensitiveCallFunction("PARSE_URL", args) => ParseUrl(args)
    case CaseInsensitiveCallFunction("PERCENTILE", args) => Percentile(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("PERCENTILE_APPROX", args) => ApproximatePercentile(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("PERCENT_RANK", args) => PercentRank(args)
    case CaseInsensitiveCallFunction("PI", _) => Pi()
    case CaseInsensitiveCallFunction("PMOD", args) => Pmod(args.head, args(1))
    case CaseInsensitiveCallFunction("POSEXPLODE", args) => PosExplode(args.head)
    case CaseInsensitiveCallFunction("POSITION", args) =>
      StringLocate(args.head, args(1), args.lastOption.getOrElse(Literal(1)))
    case CaseInsensitiveCallFunction("POSITIVE", args) => UnaryPositive(args.head)
    case CaseInsensitiveCallFunction("POW", args) => Pow(args.head, args(1))
    case CaseInsensitiveCallFunction("QUARTER", args) => Quarter(args.head)
    case CaseInsensitiveCallFunction("RADIANS", args) => ToRadians(args.head)
    case CaseInsensitiveCallFunction("RAISE_ERROR", args) => RaiseError(args.head)
    case CaseInsensitiveCallFunction("RAND", args) => Rand(args.head)
    case CaseInsensitiveCallFunction("RANDN", args) => Randn(args.head)
    case CaseInsensitiveCallFunction("RANK", args) => Rank(args)
    case CaseInsensitiveCallFunction("REGEXP_EXTRACT", args) => RegExpExtract(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("REGEXP_EXTRACT_ALL", args) => RegExpExtractAll(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("REGEXP_REPLACE", args) => RegExpReplace(args.head, args(1), args(2), args(3))
    case CaseInsensitiveCallFunction("REPEAT", args) => StringRepeat(args.head, args(1))
    case CaseInsensitiveCallFunction("REPLACE", args) => StringReplace(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("REVERSE", args) => Reverse(args.head)
    case CaseInsensitiveCallFunction("RIGHT", args) => Right(args.head, args(1))
    case CaseInsensitiveCallFunction("RINT", args) => Rint(args.head)
    case CaseInsensitiveCallFunction("RLIKE", args) => RLike(args.head, args(1))
    case CaseInsensitiveCallFunction("ROLLUP", args) => Rollup(args)
    case CaseInsensitiveCallFunction("ROUND", args) => Round(args.head, args(1))
    case CaseInsensitiveCallFunction("ROW_NUMBER", _) => RowNumber()
    case CaseInsensitiveCallFunction("RPAD", args) => StringRPad(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("RTRIM", args) => StringTrimRight(args.head, args(1))
    case CaseInsensitiveCallFunction("SCHEMA_OF_CSV", args) => SchemaOfCsv(args.head, args(1))
    case CaseInsensitiveCallFunction("SCHEMA_OF_JSON", args) => SchemaOfJson(args.head, args(1))
    case CaseInsensitiveCallFunction("SECOND", args) => Second(args.head)
    case CaseInsensitiveCallFunction("SENTENCES", args) => Sentences(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("SEQUENCE", args) => Sequence(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("SHA", args) => Sha1(args.head)
    case CaseInsensitiveCallFunction("SHA2", args) => Sha2(args.head, args(1))
    case CaseInsensitiveCallFunction("SHIFTLEFT", args) => ShiftLeft(args.head, args(1))
    case CaseInsensitiveCallFunction("SHIFTRIGHT", args) => ShiftRight(args.head, args(1))
    case CaseInsensitiveCallFunction("SHIFTRIGHTUNSIGNED", args) => ShiftRightUnsigned(args.head, args(1))
    case CaseInsensitiveCallFunction("SHUFFLE", args) => Shuffle(args.head)
    case CaseInsensitiveCallFunction("SIGN", args) => Signum(args.head)
    case CaseInsensitiveCallFunction("SIN", args) => Sin(args.head)
    case CaseInsensitiveCallFunction("SINH", args) => Sinh(args.head)
    case CaseInsensitiveCallFunction("SIZE", args) => Size(args.head)
    case CaseInsensitiveCallFunction("SKEWNESS", args) => Skewness(args.head)
    case CaseInsensitiveCallFunction("SLICE", args) => Slice(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("SORT_ARRAY", args) => SortArray(args.head, args(1))
    case CaseInsensitiveCallFunction("SOUNDEX", args) => SoundEx(args.head)
    case CaseInsensitiveCallFunction("SPACE", args) => StringSpace(args.head)
    case CaseInsensitiveCallFunction("SPARK_PARTITION_ID", _) => SparkPartitionID()
    case CaseInsensitiveCallFunction("SPLIT", args) => StringSplit(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("SQRT", args) => Sqrt(args.head)
    case CaseInsensitiveCallFunction("STACK", args) => Stack(args)
    case CaseInsensitiveCallFunction("STD", args) => StdSamp(args.head)
    case CaseInsensitiveCallFunction("STDDEV", args) => StddevSamp(args.head)
    case CaseInsensitiveCallFunction("STDDEV_POP", args) => StddevPop(args.head)
    case CaseInsensitiveCallFunction("STR_TO_MAP", args) => StringToMap(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("SUBSTR", args) => Substring(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("SUBSTRING_INDEX", args) => SubstringIndex(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("SUM", args) => Sum(args.head)
    case CaseInsensitiveCallFunction("TAN", args) => Tan(args.head)
    case CaseInsensitiveCallFunction("TANH", args) => Tanh(args.head)
    case CaseInsensitiveCallFunction("TIMESTAMP_MICROS", args) => MicrosToTimestamp(args.head)
    case CaseInsensitiveCallFunction("TIMESTAMP_MILLIS", args) => MillisToTimestamp(args.head)
    case CaseInsensitiveCallFunction("TIMESTAMP_SECONDS", args) => SecondsToTimestamp(args.head)
    case CaseInsensitiveCallFunction("TO_CSV", args) => StructsToCsv(args.head, args(1))
    case CaseInsensitiveCallFunction("TO_DATE", args) => ParseToDate(args.head, args(1))
    case CaseInsensitiveCallFunction("TO_JSON", args) => StructsToJson(args.head, args(1))
    case CaseInsensitiveCallFunction("TO_TIMESTAMP", args) => ParseToTimestamp(args.head, args(1))
    case CaseInsensitiveCallFunction("TO_UNIX_TIMESTAMP", args) => ToUnixTimestamp(args.head, args(1))
    case CaseInsensitiveCallFunction("TO_UTC_TIMESTAMP", args) => ToUTCTimestamp(args.head, args(1))
    case CaseInsensitiveCallFunction("TRANSFORM", args) => ArrayTransform(args.head, args(1))
    case CaseInsensitiveCallFunction("TRANSFORM_KEYS", args) => TransformKeys(args.head, args(1))
    case CaseInsensitiveCallFunction("TRANSFORM_VALUES", args) => TransformValues(args.head, args(1))
    case CaseInsensitiveCallFunction("TRANSLATE", args) => StringTranslate(args.head, args(1), args(2))
    case CaseInsensitiveCallFunction("TRIM", args) => StringTrim(args.head, args(1))
    case CaseInsensitiveCallFunction("TRUNC", args) => TruncDate(args.head, args(1))
    case CaseInsensitiveCallFunction("TYPEOF", args) => TypeOf(args.head)
    case CaseInsensitiveCallFunction("UCASE", args) => Upper(args.head)
    case CaseInsensitiveCallFunction("UNBASE64", args) => UnBase64(args.head)
    case CaseInsensitiveCallFunction("UNHEX", args) => Unhex(args.head)
    case CaseInsensitiveCallFunction("UNIX_DATE", args) => UnixDate(args.head)
    case CaseInsensitiveCallFunction("UNIX_MICROS", args) => UnixMicros(args.head)
    case CaseInsensitiveCallFunction("UNIX_MILLIS", args) => UnixMillis(args.head)
    case CaseInsensitiveCallFunction("UNIX_SECONDS", args) => UnixSeconds(args.head)
    case CaseInsensitiveCallFunction("UNIX_TIMESTAMP", args) => UnixTimestamp(args.head, args(1))
    case CaseInsensitiveCallFunction("UUID", _) => Uuid()
    case CaseInsensitiveCallFunction("VAR_POP", args) => VariancePop(args.head)
    case CaseInsensitiveCallFunction("VAR_SAMP", args) => VarianceSamp(args.head)
    case CaseInsensitiveCallFunction("VERSION", _) => SparkVersion()
    case CaseInsensitiveCallFunction("WEEKDAY", args) => WeekDay(args.head)
    case CaseInsensitiveCallFunction("WEEKOFYEAR", args) => WeekOfYear(args.head)
    case CaseInsensitiveCallFunction("WHEN", _) =>
      throw new IllegalArgumentException("WHEN (CaseWhen) should be handled separately")
    case CaseInsensitiveCallFunction("WIDTH_BUCKET", args) => WidthBucket(args.head, args(1), args(2), args(3))
    case CaseInsensitiveCallFunction("WINDOW", _) =>
      throw new IllegalArgumentException("WINDOW (TimeWindow) should be handled separately")
    case CaseInsensitiveCallFunction("XPATH", args) => XPathList(args.head, args(1))
    case CaseInsensitiveCallFunction("XPATH_BOOLEAN", args) => XPathBoolean(args.head, args(1))
    case CaseInsensitiveCallFunction("XPATH_DOUBLE", args) => XPathDouble(args.head, args(1))
    case CaseInsensitiveCallFunction("XPATH_FLOAT", args) => XPathFloat(args.head, args(1))
    case CaseInsensitiveCallFunction("XPATH_INT", args) => XPathInt(args.head, args(1))
    case CaseInsensitiveCallFunction("XPATH_LONG", args) => XPathLong(args.head, args(1))
    case CaseInsensitiveCallFunction("XPATH_SHORT", args) => XPathShort(args.head, args(1))
    case CaseInsensitiveCallFunction("XPATH_STRING", args) => XPathString(args.head, args(1))
    case CaseInsensitiveCallFunction("XXHASH64", args) => XxHash64(args)
    case CaseInsensitiveCallFunction("YEAR", args) => Year(args.head)
    case CaseInsensitiveCallFunction("ZIP_WITH", args) => ZipWith(args.head, args(1), args(2))
...
class SnowflakeCallMapper extends CallMapper {
  ...
  override def convert(call: Fn): Fn = {
    call match {
      case CaseInsensitiveCallFunction("DATEADD", args) =>
        DateAdd(args(0), args(1))
      case CaseInsensitiveCallFunction("REGEXP_LIKE", args) =>
        RLike(args(0), args(1))
