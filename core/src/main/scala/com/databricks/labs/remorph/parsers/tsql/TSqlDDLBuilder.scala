...
class TSqlDDLBuilder(vc: TSqlVisitorCoordinator)
  ...
  // implemented
  protected override def wrapUnresolvedInput(unparsedInput: RuleNode): ir.UnresolvedCatalog =
  ...
  protected override def defaultResult(): ir.Catalog = {
    ir.UnresolvedCatalog("Unimplemented visitor returns defaultResult!")
  }
