...
class TSqlDDLBuilder(override val vc: TSqlVisitorCoordinator)
    extends TSqlParserBaseVisitor[ir.WithKnownOrigin[ir.Catalog]]
  ...
  override def visitCreateTable(ctx: TSqlParser.CreateTableContext): ir.WithKnownOrigin[ir.Catalog] =
  ...
  override def visitCreateInternal(ctx: TSqlParser.CreateInternalContext): ir.WithKnownOrigin[ir.Catalog] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitCreateExternal(ctx: TSqlParser.CreateExternalContext): ir.WithKnownOrigin[ir.Catalog] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
   ...
   *   the parse tree
   */
  override def visitBackupStatement(ctx: TSqlParser.BackupStatementContext): ir.WithKnownOrigin[ir.Catalog] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitBackupDatabase(ctx: TSqlParser.BackupDatabaseContext): ir.WithKnownOrigin[ir.Catalog] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDdlClause(ctx: TSqlParser.DdlClauseContext): ir.WithKnownOrigin[ir.Catalog] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
