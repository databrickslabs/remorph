...
class TSqlDDLBuilder(override val vc: TSqlVisitorCoordinator)
    extends TSqlParserBaseVisitor[ir.WithKnownLocationRange[ir.Catalog]]
  ...
  override def visitCreateTable(ctx: TSqlParser.CreateTableContext): ir.WithKnownLocationRange[ir.Catalog] = {
  ...
  override def visitCreateInternal(ctx: TSqlParser.CreateInternalContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ...
          val (columns, virtualColumns, constraints, indices) = Option(ctx.columnDefTableConstraints()).toSeq
            ...
            .foldLeft(
              (Seq.empty[TSqlColDef], Seq.empty[TSqlColDef], Seq.empty[ir.Constraint], Seq.empty[ir.Constraint])) {
  ...
  override def visitCreateExternal(ctx: TSqlParser.CreateExternalContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
   ...
   *   the parse tree
   */
  override def visitBackupStatement(ctx: TSqlParser.BackupStatementContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitBackupDatabase(ctx: TSqlParser.BackupDatabaseContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitDdlClause(ctx: TSqlParser.DdlClauseContext): ir.WithKnownLocationRange[ir.Catalog] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ctx match {
            ...
            case c if c.createNonclusteredColumnstoreIndex() != null =>
              c.createNonclusteredColumnstoreIndex().accept(this)
