...
import com.databricks.labs.remorph.parsers.{LocationTracking, ParserCommon, XmlFunction, tsql}
...
class TSqlExpressionBuilder(override val vc: TSqlVisitorCoordinator)
    extends TSqlParserBaseVisitor[ir.WithKnownLocationRange[ir.Expression]]
  ...
  override def visitOptionClause(ctx: TSqlParser.OptionClauseContext): ir.WithKnownLocationRange[ir.Expression] = {
  ...
  override def visitUpdateElemCol(ctx: TSqlParser.UpdateElemColContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitUpdateElemUdt(ctx: TSqlParser.UpdateElemUdtContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitUpdateWhereClause(ctx: UpdateWhereClauseContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
   ...
   */
  private def buildLocalAssign(ctx: TSqlParser.SelectListElemContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitExprId(ctx: ExprIdContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitFullColumnName(ctx: FullColumnNameContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
   ...
   * the parse tree
   */
  override def visitAsterisk(ctx: AsteriskContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprBitNot(ctx: ExprBitNotContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprUnary(ctx: ExprUnaryContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitExprOpPrec1(ctx: ExprOpPrec1Context): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprOpPrec2(ctx: ExprOpPrec2Context): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprOpPrec3(ctx: ExprOpPrec3Context): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprOpPrec4(ctx: ExprOpPrec4Context): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprFunc(ctx: ExprFuncContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprDollar(ctx: ExprDollarContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprStar(ctx: ExprStarContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprFuncVal(ctx: ExprFuncValContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPrimitiveExpression(ctx: PrimitiveExpressionContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitConstant(ctx: TSqlParser.ConstantContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprTz(ctx: ExprTzContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScNot(ctx: TSqlParser.ScNotContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScAnd(ctx: TSqlParser.ScAndContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScOr(ctx: TSqlParser.ScOrContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScPred(ctx: TSqlParser.ScPredContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScPrec(ctx: TSqlParser.ScPrecContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredFreetext(ctx: PredFreetextContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
      ...
      errorCheck(ctx) match {
        ...
        case None =>
          val in = if (ctx.selectStatement() != null) {
            ...
            ir.In(
              ctx.expression().accept(this),
              Seq(ir.ScalarSubquery(ctx.selectStatement().accept(vc.relationBuilder))))
          } else {
  ...
  override def visitPredLike(ctx: PredLikeContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredExpression(ctx: PredExpressionContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildPrimitive(con: Token): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromToken(con) {
      con.getType match {
  ...
  override def visitExprAll(ctx: ExprAllContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPartitionFunction(ctx: PartitionFunctionContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
   ...
   * the parse tree
   */
  override def visitNextValueFor(ctx: NextValueForContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitCast(ctx: CastContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitJsonArray(ctx: JsonArrayContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitJsonObject(ctx: JsonObjectContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitFreetextFunction(ctx: FreetextFunctionContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitHierarchyidStaticMethod(
      ctx: HierarchyidStaticMethodContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitOutputDmlListElem(ctx: OutputDmlListElemContext): ir.WithKnownLocationRange[ir.Expression] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
