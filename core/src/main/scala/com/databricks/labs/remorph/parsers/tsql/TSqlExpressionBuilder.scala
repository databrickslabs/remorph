...
class TSqlExpressionBuilder(override val vc: TSqlVisitorCoordinator)
    extends TSqlParserBaseVisitor[ir.WithKnownOrigin[ir.Expression]]
  ...
  override def visitOptionClause(ctx: TSqlParser.OptionClauseContext): ir.WithKnownOrigin[ir.Expression] =
  ...
  override def visitUpdateElemCol(ctx: TSqlParser.UpdateElemColContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitUpdateElemUdt(ctx: TSqlParser.UpdateElemUdtContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitUpdateWhereClause(ctx: UpdateWhereClauseContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprId(ctx: ExprIdContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitFullColumnName(ctx: FullColumnNameContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
   ...
   * the parse tree
   */
  override def visitAsterisk(ctx: AsteriskContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
        ctx match {
  ...
  override def visitExprBitNot(ctx: ExprBitNotContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitExprUnary(ctx: ExprUnaryContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
  ...
  override def visitExprOpPrec1(ctx: ExprOpPrec1Context): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprOpPrec2(ctx: ExprOpPrec2Context): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprOpPrec3(ctx: ExprOpPrec3Context): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprOpPrec4(ctx: ExprOpPrec4Context): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprFunc(ctx: ExprFuncContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitExprDollar(ctx: ExprDollarContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
        ir.DollarAction()
  ...
  override def visitExprStar(ctx: ExprStarContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
        ir.Star(None)
  ...
  override def visitExprFuncVal(ctx: ExprFuncValContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPrimitiveExpression(ctx: PrimitiveExpressionContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitConstant(ctx: TSqlParser.ConstantContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprTz(ctx: ExprTzContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
        val expression = ctx.expression().accept(this)
  ...
  override def visitScNot(ctx: TSqlParser.ScNotContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScAnd(ctx: TSqlParser.ScAndContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScOr(ctx: TSqlParser.ScOrContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitScPred(ctx: TSqlParser.ScPredContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitScPrec(ctx: TSqlParser.ScPrecContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredFreetext(ctx: PredFreetextContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitPredLike(ctx: PredLikeContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
        val left = ctx.expression(0).accept(this)
  ...
  override def visitPredExpression(ctx: PredExpressionContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitExprAll(ctx: ExprAllContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitPartitionFunction(ctx: PartitionFunctionContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
   ...
   * the parse tree
   */
  override def visitNextValueFor(ctx: NextValueForContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitCast(ctx: CastContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
        val expression = ctx.expression().accept(this)
  ...
  override def visitJsonArray(ctx: JsonArrayContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitJsonObject(ctx: JsonObjectContext): ir.WithKnownOrigin[ir.Expression] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitFreetextFunction(ctx: FreetextFunctionContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitHierarchyidStaticMethod(ctx: HierarchyidStaticMethodContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitOutputDmlListElem(ctx: OutputDmlListElemContext): ir.WithKnownOrigin[ir.Expression] =
    withOriginFromContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
