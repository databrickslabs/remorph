...
class TSqlDMLBuilder(override val vc: TSqlVisitorCoordinator)
    extends TSqlParserBaseVisitor[ir.WithKnownLocationRange[ir.Modification]]
    with ParserCommon[ir.Modification]
    with LocationTracking {

  // The default result is returned when there is no visitor implemented, and we produce an unresolved
  // object to represent the input that we have no visitor for.
  protected override def unresolved(ruleText: String, message: String): ir.WithKnownLocationRange[ir.Modification] =
  ...
  override def visitDmlClause(ctx: DmlClauseContext): ir.WithKnownLocationRange[ir.Modification] = {
  ...
  override def visitMerge(ctx: MergeContext): ir.WithKnownLocationRange[ir.Modification] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildWhenMatch(ctx: WhenMatchContext): ir.WithKnownLocationRange[ir.MergeAction] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  private def buildInsertAction(
      ...
      condition: Option[ir.Expression]): ir.WithKnownLocationRange[ir.MergeAction] = {
    withLocationRangeFromRuleContext(ctx) {
      ctx match {
        ...
        case _ =>
          val assignments =
            (ctx.cols
              .expression()
              .asScala
              .map(_.accept(vc.expressionBuilder)) zip ctx.vals
              .expression()
              .asScala
  ...
  private def buildUpdateAction(
      ctx: MergeActionContext,
      condition: Option[ir.Expression]): ir.WithKnownLocationRange[ir.UpdateAction] = {
    withLocationRangeFromRuleContext(ctx) {
  ...
  override def visitUpdate(ctx: UpdateContext): ir.WithKnownLocationRange[ir.Modification] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
          ...
          val tableSourcesOption =
            Option(ctx.tableSources()).map(_.tableSource().asScala.map(_.accept(vc.relationBuilder)))
  ...
  override def visitDelete(ctx: DeleteContext): ir.WithKnownLocationRange[ir.Modification] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  override def visitInsert(ctx: InsertContext): ir.WithKnownLocationRange[ir.Modification] = {
    withLocationRangeFromRuleContext(ctx) {
      errorCheck(ctx) match {
        case Some(errorResult) => errorResult
        case None =>
  ...
  private def buildInsertStatementValue(ctx: InsertStatementValueContext): ir.WithKnownLocationRange[ir.LogicalPlan] = {
    withLocationRangeFromRuleContext(ctx) {
      Option(ctx) match {
