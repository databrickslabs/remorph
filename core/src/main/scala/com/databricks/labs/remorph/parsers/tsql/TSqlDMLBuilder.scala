...
class TSqlDMLBuilder(override val vc: TSqlVisitorCoordinator)
    extends TSqlParserBaseVisitor[ir.WithKnownOrigin[ir.Modification]]
  ...
  override def visitDmlClause(ctx: DmlClauseContext): ir.WithKnownOrigin[ir.Modification] = withOriginFromContext(ctx) {
  ...
  override def visitMerge(ctx: MergeContext): ir.WithKnownOrigin[ir.Modification] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitUpdate(ctx: UpdateContext): ir.WithKnownOrigin[ir.Modification] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
  ...
  override def visitDelete(ctx: DeleteContext): ir.WithKnownOrigin[ir.Modification] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
        val target = ctx.ddlObject().accept(vc.relationBuilder)
  ...
  override def visitInsert(ctx: InsertContext): ir.WithKnownOrigin[ir.Modification] = withOriginFromContext(ctx) {
    errorCheck(ctx) match {
      case Some(errorResult) => errorResult
      case None =>
        val target = ctx.ddlObject().accept(vc.relationBuilder)
