...
class SnowflakeCallMapper extends ir.CallMapper with ir.IRHelpers {
  ...
  override def convert(call: ir.Fn): ir.Expression = {
    withNormalizedName(call) match {
      ...
      case ir.CallFunction("SEQ1", args) =>
        // TODO: Warn users about The seq[1/2/4/8] function in Snowflake and monotonically_increasing_id in Databricks
        //  are equivalent in logic,
